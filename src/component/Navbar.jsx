  ...
  return (
    <nav className="navbar-main flex justify-between ">
      <div className="navbar-logo-svg  ">
        <div className="navbar-logo-svg1 ">
          <svg
            className="h-[80%] "
            width="106"
            height="83"
          ...
          >
            ...
            <defs>
              <clipPath id="clip0_2228_162">
                <rect width="106" height="82.3538" fill="white" />
              </clipPath>
            </defs>
          </svg>
        </div>
        <div className="navbar-logo-svg2 ">
          <svg
            width="62"
            height="63"
            viewBox="0 0 62 63"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="go1438215768" // Changed 'class' to 'className'
            style={{ transform: "translate(0px, -88px)" }} // Changed style attribute format
          >
            <path
...
// const Navbar = () => {
//   return (
//     <nav className="font-[aeonik-regular] mb-5 absoulte top-0 bg-gray-400 flex gap-5 w-[100%] p-5 justify-center items-center ">
//       <NavLink to="/" className="relative group text-2xl px-2">
//         {({ isActive }) => (
//           <span
//             className={`text-white relative after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-0 after:h-[2px] after:bg-current after:transition-all after:duration-300 after:ease-in-out after:-translate-x-1/2 group-hover:after:w-full ${
...
//         )}
//       </NavLink>
//       <NavLink to="about" className="relative group text-2xl px-2">
//         {({ isActive }) => (
//           <span
//             className={`text-white relative after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-0 after:h-[2px] after:bg-current after:transition-all after:duration-300 after:ease-in-out after:-translate-x-1/2 group-hover:after:w-full ${
//               isActive ? "text-red-500 after:w-full" : ""
...
//         )}
//       </NavLink>
//       <NavLink to="/setting" className="relative group text-2xl px-2">
//         {({ isActive }) => (
//           <span
//             className={`text-white relative after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-0 after:h-[2px] after:bg-current after:transition-all after:duration-300 after:ease-in-out after:-translate-x-1/2 group-hover:after:w-full ${
//               isActive ? "text-red-500 after:w-full" : ""
...
//         )}
//       </NavLink>
//       <NavLink to="/contact" className="relative group text-2xl px-2">
//         {({ isActive }) => (
//           <span
//             className={`text-white relative after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-0 after:h-[2px] after:bg-current after:transition-all after:duration-300 after:ease-in-out after:-translate-x-1/2 group-hover:after:w-full ${
//               isActive ? "text-red-500 after:w-full" : ""
...
//       <NavLink to="/user" className="relative group text-2xl px-2">
//         {({ isActive } = e) => (
//           <span
//             className={`text-white relative after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-0 after:h-[2px] after:bg-current after:transition-all after:duration-300 after:ease-in-out after:-translate-x-1/2 group-hover:after:w-full
//               // ${isActive ? "text-red-500 after:w-full" : ""}`}
